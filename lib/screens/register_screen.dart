          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                input(nameController, 'Full Name', Icons.person),
                input(studentIdController, 'Student ID', Icons.badge),
                input(programmeController, 'Programme', Icons.school),
                input(yearController, 'Year', Icons.calendar_month),
                input(emailController, 'Email', Icons.email),
                input(
                  passwordController,
                  'Password',
                  Icons.lock,
